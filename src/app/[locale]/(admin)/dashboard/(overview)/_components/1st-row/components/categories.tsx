...
export default function Categories() {
  ...
  return (
    <div className="md:bg-white w-full md:w-[490px] h-80 rounded-2xl md:p-6 overflow-y-auto scrollBar-hidden">
      {/* Title */}
      ...
      {categories.length &&
        categories.map((category) => (
          ...
          >
            ...
            {/* number of products */}
            <p className="flex gap-2 px-2 py-1 bg-zinc-100 rounded-md">
