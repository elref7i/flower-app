  ...
  return (
    <section className="mt-36">
      ...
      <div className="my-10 text-center">
        ...
        <h3 className="relative mx-auto w-fit text-4xl font-bold text-maroon-700 before:absolute before:bottom-0 before:h-[2px] before:w-[30%] before:bg-maroon-400 before:dark:bg-softpink-600 after:absolute after:bottom-0 after:left-0 after:-z-10 after:h-1/2 after:w-[70%] after:rounded-e-full after:bg-maroon-100 dark:text-softpink-200  after:dark:bg-zinc-700 after:rtl:right-0">
