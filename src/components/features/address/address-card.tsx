    ...
    <>
      {addresses.map((address) => {
        return (
          <Card
            key={address._id}
            className="mt-4 pt-6 pb-5 rounded-md border-zinc-300 hover:border-zinc-400 transition duration-300 relative"
          >
            <CardContent>
              {/*header*/}
              <div className="flex justify-between items-center">
                ...
                <div className="gap-2.5 flex">
                  ...
                  {/*city*/}
                  <h3 className="capitalize text-zinc-800 text-2xl font-semibold dark:text-white">
                    {address.city}
                  </h3>
                </div>
                <div className="flex">
                  ...
                  {/*phone*/}
                  <h3 dir="ltr" className="font-medium text-zinc-600 text-lg dark:text-white">
                    {address.phone}
                  </h3>
                </div>
              </div>
